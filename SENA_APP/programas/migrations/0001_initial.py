    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_formacion', models.CharField(choices=[('AUX', 'Auxiliar'), ('OPE', 'Operario'), ('TEC', 'Tecnico'), ('TGL', 'Tecnologo'), ('ESP', 'Especializacion Tecnologica'), ('COM', 'Complementario')], max_length=3, verbose_name='Nivel de Formación')),
