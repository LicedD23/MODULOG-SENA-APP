...
class ProgramaForm(forms.Form):
    codigo = forms.CharField(max_length=20, label="Código del Programa", help_text="Ingrese el código del programa de formación.")
    nombre = forms.CharField(max_length=200, label="Nombre del Programa", help_text="Ingrese el nombre del programa de formación.")
    ...
    descripcion = forms.CharField(max_length=200, label="Descripción del Programa", help_text="Ingrese la descripción del programa de formación.")
    ...
    regional = forms.CharField(max_length=200, label="Regional", help_text="Ingrese el regional del programa de formación.")
    ...
    fecha_registro = forms.DateTimeField(label="Fecha de Registro", help_text="Ingrese la fecha de registro del programa de formación.",)
