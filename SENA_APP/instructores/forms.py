...
class InstructorForm(forms.Form):
    documento_identidad=forms.CharField(max_length=20,label="Documeto de Identidad",help_text="Ingrese el numero de documento de identidad del instructor. ")
    ...
    telefono=forms.CharField(max_length=10,required=False, label="Telefono",help_text="Ingrese el numero  de telefono delinstructor.")
    correo=forms.EmailField(required=False, label="Correo Electronico",help_text="Ingrese elcorreo  electronico  del instructor.")
    ...
    direccion=forms.CharField(widget=forms.Textarea, required=False, label="Direccion",help_text="Ingrese la direccion del instructor.")
    nivel_educativo = forms.ChoiceField(choices=Instructor.NIVEL_EDUCATIVO_CHOICE,label="Nivel  Educativo",help_text="Selecciona el nivel educativo  del instructor.")
    ...
    activo = forms.BooleanField(required=False,initial=True,label="Activo",help_text="Indique si el instructor est activo.")
    fecha_vinculacion=forms.DateField(label="Fecha de Vinculacion",help_text="Ingrese la fecha de vinculacion del instructor.")
    ...
    def save(self):
        """Metodo para guardar al instructor en la base de datos."""
        try:
